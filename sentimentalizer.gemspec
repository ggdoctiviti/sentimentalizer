...
# -*- encoding: utf-8 -*-
# stub: sentimentalizer 0.3.5 ruby lib

Gem::Specification.new do |s|
  s.name = "sentimentalizer".freeze
  s.version = "0.3.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["malavbhavsar".freeze]
  s.date = "2023-02-17"
  s.description = "Sentiment analysis with ruby.".freeze
  s.email = "malav.bhavsar@gmail.com".freeze
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.md"
  ]
  ...
  s.homepage = "http://github.com/malavbhavsar/sentimentalizer".freeze
